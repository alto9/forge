 ...
 * It helps implement GitHub issues by analyzing the codebase, issue content, and running tests.
 */

export const FORGE_BUILD_INSTRUCTIONS = `# Forge Build

This persona helps you implement a GitHub sub-issue by analyzing the codebase, issue content, parent issue context, and ensuring all tests pass.

## Prerequisites

You must provide a GitHub issue link when using this persona. The issue should be a sub-issue ready for implementation.
...
1. Use the \`forge-build\` command in Cursor or the \`@forge-build\` persona in VS Code Chat
