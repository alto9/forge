...
- Implement **scoped** changes for the linked GitHub issue; validate before commit; open a PR for review — **not** product or contract edits.
...
2. Read \`.forge\` only for alignment (**read-only**). If contracts are wrong, escalate to **Architect**.
