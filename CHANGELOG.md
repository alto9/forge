...
* Add question panel webview with draft persistence and submit flow. ([8ea9806](https://github.com/alto9/forge/commit/8ea9806)), closes [#62](https://github.com/alto9/forge/issues/62) [#27](https://github.com/alto9/forge/issues/27)
* feat!: Forge v4 superrepo init and harness; remove Temporal ([a0b78ae](https://github.com/alto9/forge/commit/a0b78ae))
* feat!: replace the bundled harness with the Cursor plugin installer ([91ebf9e](https://github.com/alto9/forge/commit/91ebf9e))
* Merge pull request #71 from alto9/chore/manual-cut-release ([d624108](https://github.com/alto9/forge/commit/d624108)), closes [#71](https://github.com/alto9/forge/issues/71)
* Merge pull request #72 from alto9/feature/issue-26 ([f2769d1](https://github.com/alto9/forge/commit/f2769d1)), closes [#72](https://github.com/alto9/forge/issues/72) [#26](https://github.com/alto9/forge/issues/26)
* Merge pull request #73 from alto9/feature/issue-27 ([75e51b4](https://github.com/alto9/forge/commit/75e51b4)), closes [#73](https://github.com/alto9/forge/issues/73) [#27](https://github.com/alto9/forge/issues/27)
* Merge pull request #74 from alto9/feature/issue-28 ([9bfe7e4](https://github.com/alto9/forge/commit/9bfe7e4)), closes [#74](https://github.com/alto9/forge/issues/74) [#28](https://github.com/alto9/forge/issues/28) [#68](https://github.com/alto9/forge/issues/68) [#69](https://github.com/alto9/forge/issues/69)
* Merge pull request #84 from alto9/feature/issue-75 ([627c2fc](https://github.com/alto9/forge/commit/627c2fc)), closes [#84](https://github.com/alto9/forge/issues/84)
* Merge pull request #85 from alto9/feature/issue-76 ([086c4b9](https://github.com/alto9/forge/commit/086c4b9)), closes [#85](https://github.com/alto9/forge/issues/85)
* Merge pull request #86 from alto9/feature/issue-77 ([9995c7b](https://github.com/alto9/forge/commit/9995c7b)), closes [#86](https://github.com/alto9/forge/issues/86) [#77](https://github.com/alto9/forge/issues/77)
* Merge pull request #87 from alto9/feature/issue-78 ([6fb6052](https://github.com/alto9/forge/commit/6fb6052)), closes [#87](https://github.com/alto9/forge/issues/87) [#78](https://github.com/alto9/forge/issues/78)
* Merge pull request #88 from alto9/feature/issue-79 ([b969f26](https://github.com/alto9/forge/commit/b969f26)), closes [#88](https://github.com/alto9/forge/issues/88)
* Merge pull request #89 from alto9/feature/issue-80 ([5a46b8b](https://github.com/alto9/forge/commit/5a46b8b)), closes [#89](https://github.com/alto9/forge/issues/89) [#80](https://github.com/alto9/forge/issues/80)
* Merge pull request #90 from alto9/feature/issue-81 ([c016b53](https://github.com/alto9/forge/commit/c016b53)), closes [#90](https://github.com/alto9/forge/issues/90) [#81](https://github.com/alto9/forge/issues/81)
* Merge pull request #91 from alto9/feature/issue-82 ([6572932](https://github.com/alto9/forge/commit/6572932)), closes [#91](https://github.com/alto9/forge/issues/91)
* Merge pull request #92 from alto9/feature/issue-83 ([175cfdd](https://github.com/alto9/forge/commit/175cfdd)), closes [#92](https://github.com/alto9/forge/issues/92)
* Merge pull request #93 from alto9/feature/forge-v4-superrepo ([52b0571](https://github.com/alto9/forge/commit/52b0571)), closes [#93](https://github.com/alto9/forge/issues/93)
* Merge pull request #94 from alto9/feature/forge-v4-superrepo ([cad689a](https://github.com/alto9/forge/commit/cad689a)), closes [#94](https://github.com/alto9/forge/issues/94)
* Switch Forge to manual Cut Release workflow like kube9-vscode. ([e15629f](https://github.com/alto9/forge/commit/e15629f))
* fix(catalog): keep Start Run success in place without opening graph ([31ec821](https://github.com/alto9/forge/commit/31ec821))
* fix(harness): rename /build skill to /build-from-github ([6816396](https://github.com/alto9/forge/commit/6816396))
* fix(harness): session-scoped worktrees for multi-human commands ([d390ec5](https://github.com/alto9/forge/commit/d390ec5))
* feat(commands): route refine-issue through declared run_inputs.issue_ref ([364cdfd](https://github.com/alto9/forge/commit/364cdfd))
* feat(temporal): gate catalog Start Run through validated orchestration ([9c8b3fe](https://github.com/alto9/forge/commit/9c8b3fe)), closes [#79](https://github.com/alto9/forge/issues/79) [#78](https://github.com/alto9/forge/issues/78)
* feat(temporal): guard View graph by run recovery state ([b47e9eb](https://github.com/alto9/forge/commit/b47e9eb))
* feat(temporal): persist accepted workflow runs into the window index ([613b3c5](https://github.com/alto9/forge/commit/613b3c5))
* feat(temporal): refresh Workflow Runs list after successful catalog start ([496be33](https://github.com/alto9/forge/commit/496be33))
* feat(temporal): surface blocked and failed starts through existing diagnostics ([a0e1385](https://github.com/alto9/forge/commit/a0e1385))
* feat(temporal): wire human-answer projection and submit contract (#61) ([7570de3](https://github.com/alto9/forge/commit/7570de3)), closes [#61](https://github.com/alto9/forge/issues/61)
* feat(workflows): add first-class run inputs and Start Run handoff ([0406f82](https://github.com/alto9/forge/commit/0406f82))
* feat(workflows): add React Flow graph webview with step list (#60) ([1957280](https://github.com/alto9/forge/commit/1957280)), closes [#60](https://github.com/alto9/forge/issues/60) [#26](https://github.com/alto9/forge/issues/26)
* feat(workflows): build run inspector detail model for #68 ([ec0befd](https://github.com/alto9/forge/commit/ec0befd)), closes [#68](https://github.com/alto9/forge/issues/68)
* feat(workflows): build workflow graph model for run visualization (#59) ([b41dd66](https://github.com/alto9/forge/commit/b41dd66)), closes [#59](https://github.com/alto9/forge/issues/59)
* feat(workflows): render run inspector detail panel in graph webview for #69 ([7247074](https://github.com/alto9/forge/commit/7247074)), closes [#69](https://github.com/alto9/forge/issues/69)
* test(workflows): cover run input pre-start gate for issue #76 ([3aa2d2c](https://github.com/alto9/forge/commit/3aa2d2c)), closes [#76](https://github.com/alto9/forge/issues/76)
* docs(ai): forge temporal workflow runs contract updates ([226a96d](https://github.com/alto9/forge/commit/226a96d))
* docs(ai): refine issue #75 contract updates ([1c07f5a](https://github.com/alto9/forge/commit/1c07f5a)), closes [#75](https://github.com/alto9/forge/issues/75)
* docs(ai): refine issue #76 contract updates ([b689de4](https://github.com/alto9/forge/commit/b689de4)), closes [#76](https://github.com/alto9/forge/issues/76)
* docs(ai): refine issue #77 contract updates ([c1b7061](https://github.com/alto9/forge/commit/c1b7061)), closes [#77](https://github.com/alto9/forge/issues/77)
* docs(ai): refine issue #78 contract updates ([f1847ae](https://github.com/alto9/forge/commit/f1847ae)), closes [#78](https://github.com/alto9/forge/issues/78)
* docs(ai): refine issue #79 contract updates ([7df60ce](https://github.com/alto9/forge/commit/7df60ce)), closes [#79](https://github.com/alto9/forge/issues/79)
* docs(ai): refine issue #80 contract updates ([d2c2f35](https://github.com/alto9/forge/commit/d2c2f35)), closes [#80](https://github.com/alto9/forge/issues/80)
* docs(ai): refine issue #81 contract updates ([e71d9f1](https://github.com/alto9/forge/commit/e71d9f1)), closes [#81](https://github.com/alto9/forge/issues/81)
* docs(ai): refine issue #82 contract updates ([1bb0f23](https://github.com/alto9/forge/commit/1bb0f23)), closes [#82](https://github.com/alto9/forge/issues/82)
* docs(ai): refine issue #83 contract updates ([e92f0da](https://github.com/alto9/forge/commit/e92f0da)), closes [#83](https://github.com/alto9/forge/issues/83)
