...
Line 3`;
    ...
    describe('validateCommandFileHash', () => {
        it('returns true for valid file with matching hash', () => {
            const validTemplate = getCommandTemplate('.cursor/commands/forge-design.md')!;
            const hash = computeContentHash(validTemplate);
            const fileContent = `<!-- forge-hash: ${hash} -->

${validTemplate}`;
            
            const isValid = validateCommandFileHash(fileContent, '.cursor/commands/forge-design.md');
...
Extra content added by user`;
            ...
            const isValid = validateCommandFileHash(tamperedContent, '.cursor/commands/forge-design.md');
...
${validTemplate}`;
    ...
    describe('generateCommandFile', () => {
        it('generates file with hash comment at top', () => {
            const generated = generateCommandFile('.cursor/commands/forge-design.md');
        ...
        it('generated file validates successfully', () => {
            const generated = generateCommandFile('.cursor/commands/forge-design.md');
            const isValid = validateCommandFileHash(generated, '.cursor/commands/forge-design.md');
        ...
        it('preserves template content integrity', () => {
            ...
            expect(contentWithoutHash).toContain('# Forge Design');
        ...
        it('generates consistent output for same path', () => {
            const generated1 = generateCommandFile('.cursor/commands/forge-design.md');
            const generated2 = generateCommandFile('.cursor/commands/forge-design.md');
    ...
    describe('integration tests', () => {
        ...
        it('validates both command file types', () => {
            const paths = [
