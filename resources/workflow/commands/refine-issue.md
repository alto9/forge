...
This command invokes the **Technical Writer** agent. User → Technical Writer → parent branch (push + link) → SME consultation → optional sub-issues on GitHub (no per-sub-issue git branches).
